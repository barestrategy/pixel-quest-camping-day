...
An 8-bit camping adventure, originally designed and drawn by Kenzie & Ashton in Scratch,
...
you've found all 7 keys, open the cave, then descend into the dark dungeon, defeat
...
drawn in code; the characters, ants, collectibles, and screens are Kenzie and Ashton's
original pixel art from their Scratch project.
